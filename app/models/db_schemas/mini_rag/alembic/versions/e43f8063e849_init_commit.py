...
Revision ID: e43f8063e849
Revises: 
Create Date: 2026-02-18 16:00:37.533546
...
def upgrade() -> None:
    ...
    op.create_index('ix_chunk_asset_id', 'chunk', ['chunk_asset_id'], unique=False)
    op.create_index('ix_chunk_project_id', 'chunk', ['chunk_project_id'], unique=False)
    # ### end Alembic commands ###


def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index('ix_chunk_project_id', table_name='chunk')
    op.drop_index('ix_chunk_asset_id', table_name='chunk')
    op.drop_table('chunk')
